              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Receive a monthly summary of your subscriptions and
                      expenses
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={() =>
                      handleToggleNotification("monthlyReports")
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={() =>
                      handleToggleNotification("newSubscriptionsDetected")
                    }
                  />
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={() =>
                      handleToggleNotification("billingReminders")
                    }
                  />
                </div>
              </div>
        ...
        <TabsContent value="accounts">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your connected email and payment accounts
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                ...
                <div className="border-t pt-6">
                  ...
                  <div className="text-center py-8 text-muted-foreground border rounded-lg">
                    ...
                    <p className="text-sm">
                      Add a payment method to automatically track charges.
                    </p>
                  </div>
                </div>
              </div>
