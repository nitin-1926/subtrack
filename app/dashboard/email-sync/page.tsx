          ...
          <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Connect your Gmail account to automatically detect
                  subscriptions and analyze your spending.
                </DialogDescription>
              </DialogHeader>
                ...
                <div className="items-center gap-4">
                  <div className="space-y-4">
                    <Alert>
                      ...
                      <AlertDescription>
                        You'll be redirected to Google to securely authorize
                        access to your Gmail account. We never see or store your
                        password.
                      </AlertDescription>
                    </Alert>
          ...
          <CardFooter className="border-t p-4 bg-muted/10">
            <div className="flex flex-col space-y-2 w-full text-sm">
              ...
              <p className="text-muted-foreground">
                Our Gmail integration scans your emails for subscription
                confirmation and payment receipts. We never store your actual
                emails, only extract subscription data.
              </p>
