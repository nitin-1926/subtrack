...
export default function ReportsPage() {
  ...
  const selectedMonths =
    timeRangeMap[timeRange as keyof typeof timeRangeMap] || 6;
  ...
  const combinedTimelineData = filteredTimelineData.expenses.map(
    (item, index) => ({
      date: item.date,
      expenses: item.amount,
      subscriptions: filteredTimelineData.subscriptions[index]?.amount || 0,
      total:
        item.amount + (filteredTimelineData.subscriptions[index]?.amount || 0),
    })
  );
        ...
        <TabsContent value="spending-trends">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track your expenses and subscriptions over time
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Distribution of your subscriptions by category
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[350px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      ...
                      >
                        {categoryBreakdowns.subscriptions.map(
                          (entry, index) => (
                            <Cell
                              key={`cell-${index}`}
        ...
        <TabsContent value="account-insights">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Compare spending across your connected accounts
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-[400px]">
