          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                Gain insights into your spending on subscription services and
            ...
            <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Connect your email accounts to automatically track your
                  subscriptions.
                </p>
              </div>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Monitor how much you're spending on subscription services each
                  month.
                </p>
              </div>
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Get insightful reports and recommendations to optimize your
                  subscriptions.
                </p>
              </div>
            </div>
      ...
      <footer className="border-t py-6 md:py-0">
        <div className="container flex flex-col items-center justify-between gap-4 md:h-24 md:flex-row">
          <p className="text-center text-sm leading-loose text-gray-500 md:text-left dark:text-gray-400">
            © 2023 SubTrack. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
